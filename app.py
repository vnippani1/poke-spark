...
class PokeSpark:
    def __init__(self) -> None:
        ...
        self.pkData = self.pkData.withColumn("Nm", func.when(func.col("Name").contains("Mega "), func.concat(func.split(func.col("Name")," ").getItem(1),func.lit(" Mega"))).otherwise(func.col("Name")))
